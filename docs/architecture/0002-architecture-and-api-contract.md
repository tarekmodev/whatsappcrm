...
| `whatsapp_accounts`                 | ✓        | `phone_number_id` **globally** unique — it is the webhook routing key               | TAR-20    |
| `message_templates`                 | ✓        | `UNIQUE (tenant_id, name, language)`; approval status                               | TAR-20    |
