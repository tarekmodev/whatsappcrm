 ...
 * `SectionErrorBoundary` and the settings form has a third from `LazyBoundary`,
...
export default function ChatbotSettingsError({
  ...
  return <RouteErrorFallback error={error} reset={reset} label="Chatbot settings route failed" />;
}
