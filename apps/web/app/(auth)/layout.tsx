    ...
    <div className={styles.layout}>
      <div className={styles.formPanel}>
        {/*
          ...
          Not a link. The chrome's lockup goes to the inbox, which is exactly
          where a signed-out visitor cannot go — they would be bounced back to
          the screen they are standing on.
        */}
        <header className={styles.band}>
          <BrandLockup branding={branding} size="lg" isLinked={false} />
        </header>
