 ...
 *
 * The bounds and the step come from `AI_CONFIG_LIMITS` rather than being typed
 * here, so the control cannot offer a value the CHECK constraint refuses, and
 * cannot produce 0.6173.
 */
      ...
      {({ controlId, describedBy }) => (
        <div className={styles.slider}>
          <input
            ...
            step={AI_CONFIG_LIMITS.minConfidenceStep}
            value={value}
            disabled={isDisabled}
