-- Reverses 20260815150000_reporting_attribution_and_anchors.
--
-- Run 20260815150100_reporting_attribution_backfill/down.sql **first** if that
...
-- in 20260815150100 reconstructs most of it on the way back up, within the
