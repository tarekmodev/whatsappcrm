 ...
 * are emitted from the send path and the delivery worker onto the in-process
 * bus; TAR-20d subscribes to them and owns the socket. A gateway declared here
 * would make the inbox depend on a transport it does not need in order to
 * record a message.
 *
